            ...
            <div class="card mb-4 mx-4 shadow" style="border: none;">
                ...
                <div class="card-body px-0 pt-0 pb-2 m-2">
                    <div class="table-responsive p-0 mt-4">
                        <table id="event-table" class="table align-items-center mb-0" style="border-bottom: 2px solid rgb(198, 190, 190) !important;">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @foreach ($events as $index => $event)
                                    <tr data-event-id="{{ $event->id }}" data-event-code="{{ $event->code }}" data-event-name="{{ $event->name }}">
                                        <td class="ps-4">
                                            <p class="text-secondary text-xs font-weight-bold mb-0"> {{ $index + 1 }} </p>
                                        </td>
                                        <td class="text-center">
                                            <p class="text-secondary text-xs font-weight-bold mb-0"> {{ $event->code }} </p>
                                        </td>
                                        <td class="text-center">
                                            <p class="text-secondary text-xs font-weight-bold mb-0"> {{ $event->name }} </p>
                                        </td>
                                        <td class="text-center">
                                        ...
                                        <td class="text-center">
                                            <a href="#" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Editar Evento" onclick="onEdit(this)">
                                                <i class="fas fa-user-edit text-secondary"></i>
                                            </a>
                                            <a href="#" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Eliminar Evento" onclick="onDelete(this)">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newEventModalLabel">Nuevo Registro</h5>
